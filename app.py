...
# PAGE CONFIGS
st.set_page_config(page_title="X-ray Disease Detection", page_icon="🫁", layout="wide")
...
MODEL_NAME = st.sidebar.radio(
    "Choose Model Architecture:", ["BaselineCNN", "EfficientNet"]
)
...
if uploaded_file:
    ...
    with col_left:
        ...
        if st.button("🔍 Analyze X-Ray", width="stretch"):
